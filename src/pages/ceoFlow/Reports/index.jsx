...
import { getCEOReportsByType, getCEOReportTypes } from "../../../store/actions/report/ceoreportaction";
...
const Report = () => {
  ...
  const handleFilterChange = (e) => {
    ...
    if (value === "All Reports") {
      // optionally clear reports or fetch all reports
    }
  };

  const filteredReports = selectedFilter === "All Reports" ? reports : reports;
  ...
  {reportTypes.map(({ reportTypeId, reportType }) => (
    <li
      ...
      onClick={() => setSelectedFilter(reportType)}
    >
      {reportType}
    </li>
  ))}
