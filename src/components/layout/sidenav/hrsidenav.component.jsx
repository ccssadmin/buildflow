      ...
      <div className="sidenav-content">
        <div className="sidenav-content__headings">
          ...
          >
            ...
            >
              <NavLink to="/hr/dashboard" className="link-tag">
                {({ isActive, isPending }) => (
                  <>
                    <img
                      src={IconDashboard}
            ...
            <h5
              ...
              disabled={auth?.details?.roleName == null ? true : false}
            >
              <NavLink to="/hr/employee" className="link-tag">
                {({ isActive, isPending }) => (
                  <>
                    <img
                      src={IconChat}
            ...
            <h5
              ...
              disabled={auth?.details?.roleName == null ? true : false}
            >
              <NavLink to="/hr/approvals" className="link-tag">
                {({ isActive, isPending }) => (
                  <>
                    <img
                      src={IconProjects}
            ...
            <h5
              ...
              disabled={auth?.details?.roleName == null ? true : false}
            >
              <NavLink to="/hr/chats" className="link-tag">
                {({ isActive, isPending }) => (
                  <>
                    <img
                      src={IconApprovals}
            ...
            <h5
              ...
              disabled={auth?.details?.roleName == null ? true : false}
            >
              <NavLink to="/hr/settings" className="link-tag">
                {({ isActive, isPending }) => (
                  <>
                    <img
                      src={IconChat}
